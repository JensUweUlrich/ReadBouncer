...
void Classify_mainwindow::on_pushButton_9_clicked()
{
    ...
    classified_file = QFileDialog::getSaveFileName(this, "save the classified reads as");

     QFile out(classified_file);
...
void Classify_mainwindow::on_pushButton_10_clicked()
{
   ...
   unclassified_file = QFileDialog::getSaveFileName(this, "save the unclassified reads as");

    QFile out(unclassified_file);
...
{
     QString classi = QString::fromLocal8Bit(classified.c_str());
     QString unclassi = QString::fromLocal8Bit(unclassified.c_str());
     ...
     QString classF {"Classified reads file: " + classi+"\n"};
     QString unclassF {"Unclassified reads file: " + unclassi+"\n"};
...
void Classify_mainwindow::on_lineEdit_3_textEdited(const QString &classify)
{
    Classify_mainwindow::classified = classify.toLocal8Bit().constData();
}

void Classify_mainwindow::on_lineEdit_4_textEdited(const QString &unclassify)
{
    Classify_mainwindow::unclassified = unclassify.toLocal8Bit().constData();
}
