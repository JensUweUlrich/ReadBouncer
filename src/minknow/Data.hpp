...
namespace readuntil
{
    ...
    class Data: public MinKnowService
    {
        ...
        public:
            ...
            void getLiveSignals(SafeQueue<RTPair>& basecall_queue);
            void sendActions(SafeQueue<RTPair>& action_queue, SafeQueue<Durations>& duration_queue);
            ...
            inline void setChannels(const uint16_t minC, const uint16_t maxC)
            {
                minChannel = minC;
                maxChannel = maxC;
            }
